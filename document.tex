...
%	\vspace{-6mm}
	...
	{PhD}{Aug 2021 - present}
	\resumeItemListStart
	\item PhD in aerospace engineering (ongoing), Research area: Numerical methods for nonlocal elasticity.
	\resumeItemListEnd
	
	\resumeSubheading
	{Government Engineering College}{Thiruvananthapuram, India}
	{M-Tech in Machine Design}{June 2019 - June 2023}
	\resumeItemListStart
	\item GPA: 9.7/10
	\resumeItemListEnd
	...
	{B-Tech}{Aug 2013 - Nov 2017}
	\resumeItemListStart
	\item GPA: 7.6/10
	\resumeItemListEnd
%	
%	\resumeSubheading
%	{SNHSS}{Thiruvananthapuram, Country}
...
%	
	...
	\resumeProject
	{Research: Solving nonlocal elasticity problems using meshfree method.}
	{Tools: MATLAB, The solution to nonlocal beam bending problems is developed in matlab.}
	{Aug 2021 - present}
	{{}[\href{https://doi.org/10.1016/j.compstruc.2025.107724}{\textcolor{darkblue}{\faIcon{globe}}}]}
	\resumeItemListStart
	\item Study of effect of selectable parameters in meshfree method on nonlocal problems.
	\item Static beam bending problem is solved using Eringen's nonlocal elasticity.
	\item Revealed the extend of nondimensional length scale.

	\resumeItemListEnd
	
	\resumeProject
	{M-Tech: Reduced order modelling of systems with localized nonlinearity}
	{Tools: ANSYS and MATLAB for modeling and analysis.}
	{March 2021}
	
	\resumeItemListStart
	\item Solved free vibration of an idealized spring mass system using harmonic balance method and Craig Bampton model reduction technique. 
	...
	\small{
		\begin{enumerate}[leftmargin=*, labelsep=0.5em, align=left, widest={[\textbf{S.1}]}, itemindent=0em, label={\textbf{[\arabic*]}]}]
						...
						\item[\textbf{[J.1]}] Akhil S L, Krishna I R Praveen, Aswathy M. (2025). \href{https://doi.org/10.1016/j.compstruc.2025.107724}{\textbf{Effect of non-dimensional length scale in element free Galerkin method for classical and strain driven nonlocal elasto-static problems}}. \textit{Computers \& Structures}, Vol. 312, May 2025, pp. 1-11. DOI: https://doi.org/10.1016/j.compstruc.2025.107724
						
						\item[\textbf{[J.2]}] S L Akhil, I R Praveen Krishna , (2025). \href{https://doi.org/10.1061/JENMDT.EMENG-8428}{\textbf{Element-Free Galerkin Method for Elastostatic Analysis of Nonlocal Stress-Driven Bernoulli–Euler Beams}}. \textit{ASCE Engineering Mechanics}, Vol. 151, 10, pp. 1-12. DOI: https://doi.org/10.1061/JENMDT.EMENG-8428
			
			\item[\textbf{[C.1]}] Akhil S L, et al. (2024). {\textbf{Element free Galerkin method(EFGM) for static analysis of nonlocal elastic solids using differential and integral strain driven models}}. In \textit{4$^th$} International conference on Mechanics of Advanced Materials and Structures,  MEchanics of advanced materials and structures. 11-13 Dec 2024, Bengaluru.
			
			 
			\item[\textbf{[C.2]}][forthcoming] Akhil S L, et al. (2025). {\textbf{Element free Galerkin method for Timoshenko nano beams using strain driven nonlocal model}}. In \textit{4$^th$} International Mechanical
			Engineering Congress \&
			Exposition India. 10-13 Sept 2025, Hyderabad.
%						
