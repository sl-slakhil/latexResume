...
%	\vspace{-6mm}
	...
	\resumeItemListStart
	\item PhD in aerospace engineering, Research area: Numerical methods for nonlocal elasticity.
	\resumeItemListEnd
...
%	
	...
	\resumeProject
	{M-Tech: Reduced order modelling of systems with localizes nonlinearity}
	...
	\small{
		\begin{enumerate}[leftmargin=*, labelsep=0.5em, align=left, widest={[\textbf{S.1}]}, itemindent=0em, label={\textbf{[\arabic*]}]}]
			...
			\item[\textbf{[C.1]}][forthcoming] Akhil S L, et al. (2025). {\textbf{Element free Galerkin method for Timoshenko nano beams using strain driven nonlocal model}}. In \textit{4$^th$} International Mechanical
